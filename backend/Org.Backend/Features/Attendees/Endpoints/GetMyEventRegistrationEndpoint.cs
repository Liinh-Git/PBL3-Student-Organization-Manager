...
public class GetMyEventRegistrationEndpoint : EndpointWithoutRequest<ApiResponse<AttendeeDto?>>
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        try
        {
            ...
            Response = ApiResponse<AttendeeDto?>.SuccessResponse(result);
        }
        ...
        catch (Exception ex)
        {
            ...
            Response = ApiResponse<AttendeeDto?>.ErrorResponse("Failed to get registration", new List<string> { ex.Message });
        }
    }
