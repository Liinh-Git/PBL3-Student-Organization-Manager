...
public class GetTaskByIdEndpoint : EndpointWithoutRequest<ApiResponse<TaskDto>>
{
    private readonly ITaskService _taskService;

    public GetTaskByIdEndpoint(ITaskService taskService)
    {
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        {
            HttpContext.Response.StatusCode = 400;
            Response = ApiResponse<TaskDto>.ErrorResponse("Failed to get task", new List<string> { ex.Message });
        }
    }
}
