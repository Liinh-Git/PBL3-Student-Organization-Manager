...
import OrgCategoryPage from "../pages/org/OrgCategoryPage";
        ...
        <Route element={<OrgMemberRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route
              ...
              element={<OrgEventDetailPage />}
            />
            <Route
              path="/org/events/:eventId/category/:categoryId"
              element={<OrgCategoryPage />}
            />
            ...
            <Route
              path="/org/resources"
              element={<OrgResourcesPlaceholderPage />}
            />
            <Route
              path="/org/reports"
              element={<OrgReportsPlaceholderPage />}
            />
            <Route
              path="/org/finance"
              element={<OrgFinancePlaceholderPage />}
            />
          </Route>
        </Route>
      </Routes>
