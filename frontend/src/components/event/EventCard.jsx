 ...
 * Updated: compact layout with icons, cover full top corners, uniform height
 */
...
function EventCard({ event, onView }) {
  ...
  return (
    <div className="event-card">
      {/* Cover image - full top corners via overflow:hidden on parent */}
      ...
      <div className="event-card-body">
        ...
        <div className="event-card-meta">
          ...
          <div className="event-card-meta-row">
            ...
            <span className="event-card-meta-val">
          ...
          {event?.location && (
            <div className="event-card-meta-row">
              ...
              <span className="event-card-meta-val event-card-meta-val--truncate">
                {event.location}
              </span>
            </div>
          )}
